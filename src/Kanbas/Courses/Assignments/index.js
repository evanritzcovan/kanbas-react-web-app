    ...
    return (
        <div>
            <div style={{ paddingTop: "40px", width: "100%" }}>
                <input className="form-control w-25 float-start" type="text" placeholder="Search for Assignment"/>
                <div style={{ float: "right", display: "inline" }}>
                    <button className="btn home-btn"style={{backgroundColor: "white",marginRight: "4px",border: "1px solid whitesmoke",}}>
                ...
                <div className="list-group">
                    <div className="list-group-item list-group-item-secondary mt-3 pb-0">
                        ...
                        <span className="float-end">
                            <button className="btn rounded-pill asgn-btn mb-2"
                    ...
                    {courseAssignments.map((assignment) => (
                        <Link key={assignment._id} to={`/Kanbas/Courses/${courseId}/Assignments/${assignment._id}`} className="list-group-item" style={{ borderLeft: "1px solid green" }}>
                            <FontAwesomeIcon icon={faEllipsisVertical}/>
                            <FontAwesomeIcon icon={faEllipsisVertical} className="me-3"/>
