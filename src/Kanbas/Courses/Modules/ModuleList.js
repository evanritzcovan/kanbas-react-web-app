            ...
            {modules.filter((module) => module.course === courseId).map((module, index) => [
                <li key={`module-${index}`} className="list-group-item list-group-item-secondary module-title">
                    <h3>
                        ...
                        <button className="btn btn-danger me-5" onClick={() => handleDeleteModule(module._id)}>
                            Delete
                        </button>
                        <span className="float-end fa-2xs" style={{ display: "inline" }}>
                            ...
                            <FontAwesomeIcon icon={faSortDown} className="fa-2xs ms-1 me-4 mb-2 weight-sm"/>
                            <FontAwesomeIcon icon={faPlus} className="fa-2xs me-4 weight-sm"/>
                            <FontAwesomeIcon icon={faEllipsisVertical} className="fa-xs me-4 pt-3 weight-sm"/>
                        </span>
                    </h3>
                </li>,
                <li key={`nested-${index}`} className="list-group-item module-description" style={{ borderLeft: "1px solid green" }}>
                    ...
                    <span className="float-end">
                        ...
                        <span className="fa-stack" style={{ marginLeft: "-1rem" }}>
                            <FontAwesomeIcon icon={faEllipsisVertical} className="fa-stack-1x" style={{ color: "grey" }}/>
                        </span>
                    </span>
                </li>,
            ])}
