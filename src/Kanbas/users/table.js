            ...
            <div className="instructions-box mb-2 p-2 pb-0">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        select <span style={{ color: "cyan" }}>'Edit This User'</span> from the table and
                        modify the fields. Then click{" "}
                        <span style={{ color: "orange" }}>'Update Selected User'.</span>
                    </li>
                    <li>
                ...
                <table className="table table-striped table-bordered">
                    ...
                    <tbody>
                        {users.map((user) => (
                            <tr key={user._id}>
                                <td>
                                    <button onClick={() => selectUser(user)} className="btn btn-info ms-3 float-start">
                                        Edit This User <BsPencil/>
                                    </button>
                                    <button className="btn btn-danger ms-5 float-start" onClick={() => deleteUser(user)}>
